...
export const routes: Routes = [
   ...
   */
  {
    ...
    loadChildren: () =>
       ...
       */
      loadRemoteModule('silly-name-for-mfe-01', './routes')
        .then((m) => m.routes)
  ...
  },
  {
    path: 'mfe02',
    loadChildren: () =>
      loadRemoteModule('mfe-02', './routes')
        .then((m) => m.routes)
        .catch(handleRemoteModuleFailure),
  },
  {
    path: 'mfe03',
    loadChildren: () =>
      loadRemoteModule('mfe-03', './routes')
        .then((m) => m.routes)
        .catch(handleRemoteModuleFailure),
  },
  {
    path: 'mfe04',
    loadChildren: () =>
      loadRemoteModule('mfe-04', './routes')
        .then((m) => m.routes)
        .catch(handleRemoteModuleFailure),
  },
  {
    path: 'mfe05',
    loadChildren: () =>
      loadRemoteModule('mfe-05', './routes')
        .then((m) => m.routes)
        .catch(handleRemoteModuleFailure),
  },
];

function handleRemoteModuleFailure() {
  return import(
